...
describe("markdown longform articles", () => {
  it("normalizes legacy local image paths to Supabase urls for frontend consumption", () => {
...
![500RR](/editorial/zhangxue/product-500rr-1.png)`);
    ...
    expect(article.longformBlocks).toEqual([
      expect.objectContaining({
        type: "image",
        src: "https://trwasyzmcfcsjvcjndrm.supabase.co/storage/v1/object/public/article-media/articles/zhangxue-profile-editorial-reillustrated/inline/product-500rr-1.png",
      }),
    ]);
  });
...
它真正难的不是做出第一辆车，而是把一套方法持续做下去。`);
    ...
    expect(article.heroImage?.src).toBe("https://trwasyzmcfcsjvcjndrm.supabase.co/storage/v1/object/public/article-media/articles/zhangxue-profile-editorial-reillustrated/hero/hero-media-news-1.jpg");
    ...
    expect(article.longformBlocks).toEqual([
      ...
      expect.objectContaining({ type: "image", src: "https://trwasyzmcfcsjvcjndrm.supabase.co/storage/v1/object/public/article-media/articles/zhangxue-profile-editorial-reillustrated/inline/product-500rr-1.png", alt: "500RR", caption: "图注：500RR 官方产品图。" }),
